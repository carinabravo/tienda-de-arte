      ...
      <div className="row">
        <div className="col-md-7 px-3 mb-3">
          ...
          <ul className="nav flex-column">
            <li className="nav-item"><a href="/inicio" className="nav-link px-0 text-muted">Inicio</a></li>
            <li className="nav-item"><a href="/obras" className="nav-link px-0 text-muted">Tienda</a></li>
